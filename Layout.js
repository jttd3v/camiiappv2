        ...
        <Sidebar className="border-r border-slate-200 bg-slate-50">
          <SidebarHeader className="border-b border-slate-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-slate-900 text-lg">CAMII</h2>
                <p className="text-xs text-slate-500 font-medium">Maritime Applications</p>
              </div>
            </div>
          </SidebarHeader>
          ...
          <SidebarFooter className="border-t border-slate-200 p-6">
            <div className="text-center">
              <div className="text-xs font-semibold text-blue-600 mb-1">Cebu Ace-Maritime</div>
              <div className="text-xs text-slate-500">International Inc.</div>
            </div>
          </SidebarFooter>
        </Sidebar>
        ...
        <main className="flex-1 flex flex-col bg-slate-50">
          <header className="bg-white border-b border-slate-200 px-6 py-4 md:hidden">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-slate-900">CAMII Applications</h1>
            </div>
          </header>
